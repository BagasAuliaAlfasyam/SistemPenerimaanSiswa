            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="/panitia" class="site_title"><i class="fa fa-paw"></i> <span>Panitia PSB</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="{{ route('panitia.dashboard') }}"><i class="fa fa-home"></i>Home<span
                                            class="#"></span></a>
                                </li>
                                <li><a><i class="fa fa-edit"></i> Data Siswa <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('panitia.calon_siswa') }}">Daftar Calon Siswa</a></li>
                                        <li><a href="{{ route('panitia.pengumuman') }}">Daftar Pengumuman</a></li>

                                    </ul>
                                </li>
                                <li>
                                    <a href="{{ route('panitia.registrasi') }}">
                                        <i class="fa fa-desktop"></i>Data Registrasi Siswa <span class="#"></span>
                                    </a>
                                </li>
                                <li><a><i class="fa fa-bar-chart-o"></i>Laporan<span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('panitia.laporancsi') }}">Data Calon Siswa</a></li>
                                        <li><a href="{{ route('panitia.laporanrus') }}">Data Registrasi</a></li>
                                        <li><a href="{{ route('panitia.laporanpgn') }}">Data Pengumuman</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
